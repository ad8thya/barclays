    ...
    <div className="glass-card p-6">
      <div className="flex items-center gap-2.5 mb-5">
        <div className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center">
          <Paperclip size={16} className="text-accent" strokeWidth={1.5} />
        </div>
      ...
      >
        ...
        {file ? (
          ...
          <>
            <Paperclip size={28} className="mb-3 text-slate-700" strokeWidth={1.2} />
            <p className="text-sm text-slate-500 mb-1">
              Drag & drop or <span className="text-accent font-medium">browse</span>
            </p>
            <p className="text-[10px] text-slate-700">Accepted: PDF, PNG, JPG</p>
          </>
        )}
      </div>
    </div>
